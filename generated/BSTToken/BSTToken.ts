...
export class BSTToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class BSTToken extends ethereum.SmartContract {
  ...
  TOKENS_PER_INVESTOR(): BigInt {
    let result = super.call(
      "TOKENS_PER_INVESTOR",
      "TOKENS_PER_INVESTOR():(uint256)",
      []
    );
  ...
  try_TOKENS_PER_INVESTOR(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "TOKENS_PER_INVESTOR",
      "TOKENS_PER_INVESTOR():(uint256)",
      []
  ...
  checkpoints(param0: Address, param1: BigInt): BSTToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new BSTToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<BSTToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new BSTToken__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
